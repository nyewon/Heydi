      ...
      <div className="flex flex-col gap-5 mt-2 px-1 text-left">
        <div className="bg-[#EFE8E1] rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[12px] font-extrabold text-[#4A4A4A]">
              아이디
            </span>
          </div>
          <p className="text-[10px] text-[#4A4A4A] leading-5">
            <span className="text-[#B28C7E] font-bold">영문+숫자</span> 조합으로
            4자 이상 입력 후{" "}
            <span className="text-[#B28C7E] font-bold">[중복 확인]</span> 버튼을
            눌러주세요. (중복확인 필수)
          </p>
        </div>
        ...
        <div className="bg-[#EFE8E1] rounded-xl p-4">
          ...
          <p className="text-[10px] text-[#4A4A4A] leading-5">
            <span className="text-[#B28C7E] font-bold">영문+숫자+특수문자</span>{" "}
        ...
        <div className="bg-[#EFE8E1] rounded-xl p-4">
          ...
          <p className="text-[10px] text-[#4A4A4A] leading-5">
            <span className="text-[#B28C7E] font-bold">
              한글/영어/숫자(혼합 가능)
            </span>
